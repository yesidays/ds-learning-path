...
- ¿Qué es el aprendizaje automático?
    ...
    - [Google: What is Machine Learning?](https://www.youtube.com/watch?v=HcqpanDadyQ&t=2s)
- Aprendizaje supervisado
    - [Supervised Learning: Crash Course AI #2](https://www.youtube.com/watch?v=4qVRBYAdLAo)
    - [Supervised vs Unsupervised vs Reinforcement Learning](https://www.youtube.com/watch?v=xtOg44r6dsE)
    - [Supervised and Unsupervised](https://www.youtube.com/watch?v=kE5QZ8G_78c)
- Aprendizaje no supervisado
    - [Unsupervised Learning: Crash Course AI #6](https://www.youtube.com/watch?v=JnnaDNNb380)
    - [Unsupervised Learning](https://www.youtube.com/watch?v=8dqdDEyzkFA&t=16s)
    - [Supervised vs Unsupervised vs Reinforcement Learning](https://www.youtube.com/watch?v=xtOg44r6dsE)
    - [Supervised and Unsupervised](https://www.youtube.com/watch?v=kE5QZ8G_78c)
- [Supervised vs Unsupervised Learning: Key Differences](https://www.guru99.com/supervised-vs-unsupervised-learning.html)
...
- Types of data
    ...
    - [Transforming Categorical to Numerical](https://www.youtube.com/watch?v=du8YTUgOCJ0)
    - [Machine Learning #43 Categorical Attributes | Decision Trees](https://www.youtube.com/watch?v=oqrYZ0feGOc)
- Datos faltantes
    - [How to Handle Missing Data](https://towardsdatascience.com/how-to-handle-missing-data-8646b18db0d4)
    - [The Trouble with Missing Data - Computerphile](https://www.youtube.com/watch?v=oCQbC818KKU)
    - [How To Handle Missing Values in Categorical Features](https://www.youtube.com/watch?v=q-DyjA8ZmYM)
...
- Outliers
    ...
    - [Outlier Analysis/Detection with Univariate Methods Using Tukey boxplots in Python (Playlist)](https://www.youtube.com/watch?v=nbNiD76yE8o&list=PL8Bgdi87Y1lWJtBDuStNuEGoXKVFmMrF3)
- Feature selection
    ...
    - [Feature Selection Techniques Easily Explained | Machine Learning](https://www.youtube.com/watch?v=EqLBAmtKMnQ)
    - [Feature Selection - Georgia Tech - Machine Learning](https://www.youtube.com/watch?v=8CpRLplmdqE)
    ...
    - [Learning Feature Selection for Building and Improving your Machine Learning Model](https://medium.com/analytics-vidhya/feature-selection-for-building-and-improving-your-machine-learning-model-e3a81b79487)
...
- Sobreajuste (overfitting) y Subajuste (underfitting)
    ...
    - [Memorizing is not learning! — 6 tricks to prevent overfitting in machine learning.](https://medium.com/hackernoon/memorizing-is-not-learning-6-tricks-to-prevent-overfitting-in-machine-learning-820b091dc42)
    ...
    - [The Problem Of Overfitting And How To Resolve It](https://medium.com/fintechexplained/the-problem-of-overfitting-and-how-to-resolve-it-1eb9456b1dfd)
    - [Overfitting](https://twitter.com/home)
    - [Underfitting and Overfitting in machine learning and how to deal with it](https://towardsdatascience.com/underfitting-and-overfitting-in-machine-learning-and-how-to-deal-with-it-6fe4a8a49dbf)
    - [But What Is Overfitting in Machine Learning?](https://www.youtube.com/watch?v=Anq4PgdASsc)
...
- Conjunto de entrenamiento y prueba
    - [Training and testing](https://www.youtube.com/watch?v=P2NqrFp8usY)
    ...
    - [Train and Test Set in Python Machine Learning — How to Split](https://medium.com/@rinu.gour123/train-and-test-set-in-python-machine-learning-how-to-split-58029a0d657b)
    - [Machine Learning with Python | Part 4 | Creating Train & Test Dataset & evaluating model with MSE](https://www.youtube.com/watch?v=6GtdvA4Q-zw)
- Reducción de dimensiones
    - [What Is Dimension Reduction In Data Science?](https://medium.com/fintechexplained/what-is-dimension-reduction-in-data-science-2aa5547f4d29)
    - [Machine Learning - Dimensionality Reduction - Feature Extraction & Selection](https://www.youtube.com/watch?v=AU_hBML2H1c)
    - [Dimension Reduction Techniques with Python](https://towardsdatascience.com/dimension-reduction-techniques-with-python-f36ca7009e5c)
    ...
    - [Dimensionality Reduction - The Math of Intelligence #5](https://www.youtube.com/watch?v=jPmV3j1dAv4)
    - [StatQuest: Principal Component Analysis (PCA), Step-by-Step](https://www.youtube.com/watch?v=FgakZw6K1QQ)
    - [Machine Learning — Visualization, Dimension Reduction & Anomaly detection](https://medium.com/@jonathan_hui/machine-learning-visualization-dimension-reduction-anomaly-detection-e5762b9093fd)
...
- Regresión lineal
    ...
    - [Linear Regression In Real Life](https://towardsdatascience.com/linear-regression-in-real-life-4a78d7159f16)
    - [What is Regression? | SSE, SSR, SST | R-squared | Errors (ε vs. e)](https://www.youtube.com/watch?v=aq8VU5KLmkY)
    ...
    - [8 ways to perform simple linear regression and measure their speed using Python](https://medium.com/free-code-camp/data-science-with-python-8-ways-to-do-linear-regression-and-measure-their-speed-b5577d75f8b)
- Logística
    ...
    - [Logistic Regression Details Pt1: Coefficients (Playlist)](https://www.youtube.com/watch?v=vN5cNN2-HWE)
    - [Logistic Regression in Python | Logistic Regression Example](https://www.youtube.com/watch?v=VCJdg7YBbAQ)

### Árboles de decisión

- Introduction
    - [Decision Tree Classifier — Theory](https://medium.com/machine-learning-101/chapter-3-decision-trees-theory-e7398adac567)
    - [StatQuest: Decision Trees](https://www.youtube.com/watch?v=7VeUPuFGJHk)
    - [Lecture: Machine learning - Decision trees](https://www.youtube.com/watch?v=-dCtJjlEEgM)
    - [Decision Tree Algorithm - Edureka](https://www.youtube.com/watch?v=qDcl-FRnwSU)
...
- Tipos de árboles
    - ID3
        ...
        - [ID3 - Georgia Tech - Machine Learning](https://www.youtube.com/watch?v=IX0iGf2wYM0)
        - [An Introduction to Decision Tree Learning: ID3 Algorithm](https://medium.com/machine-learning-guy/an-introduction-to-decision-tree-learning-id3-algorithm-54c74eb2ad55)
    ...
    - C4.5
        ...
        - [What is the C4.5 algorithm and how does it work?](https://towardsdatascience.com/what-is-the-c4-5-algorithm-and-how-does-it-work-2b971a9e7db0)
    ...
    - CART
        ...
        - [Introduction to Classification & Regression Trees (CART)](https://www.datasciencecentral.com/profiles/blogs/introduction-to-classification-regression-trees-cart)
    - Random forest
...
- Ensembles
    ...
    - [Ensemble learners](https://www.youtube.com/watch?v=Un9zObFjBH0)
...
- Pruning (podando el árbol)
    - [Decision Tree Pruning](https://www.youtube.com/watch?v=t56Nid85Thg)
    - [Machine Learning: Pruning Decision Trees](https://www.displayr.com/machine-learning-pruning-decision-trees/)
    - [Decision Trees — Pruning](https://towardsdatascience.com/decision-trees-pruning-4241cc266fef)
...
- [Bayesian Networks - Video](https://www.youtube.com/watch?v=TuGDMj43ehw)
- [Introduction to Bayesian Networks - Edureka](https://www.youtube.com/watch?v=SkC8S3wuIfg)
- [Bayesian networks - an introduction](https://www.bayesserver.com/docs/introduction/bayesian-networks)
- [How To Implement Bayesian Networks In Python? – Bayesian Networks Explained With Examples](https://www.edureka.co/blog/bayesian-networks/)
...
- [Basics of Bayesian Network](https://towardsdatascience.com/basics-of-bayesian-network-79435e11ae7b)
- Naive bayes
    - [Naïve Bayes Classifier - Fun and Easy Machine Learning](https://www.youtube.com/watch?v=CPqOCI0ahss)
    - [Naive Bayes, Clearly Explained!!!](https://www.youtube.com/watch?v=O2L2Uv9pdDA)
    - [Naive Bayes Classifier - With examples](https://www.youtube.com/watch?v=l3dZ6ZNFjo0)
...
- Introduction
    ...
    - [How Machines Make Sense of Big Data: an Introduction to Clustering Algorithms](https://medium.com/free-code-camp/how-machines-make-sense-of-big-data-an-introduction-to-clustering-algorithms-4bd97d4fbaba)
    ...
    - [Unsupervised Learning | Clustering and Association Algorithms in Machine Learning](https://www.youtube.com/watch?v=UhVn2WrzMnI)
    ...
    - [Lecture: Clustering - MIT](https://www.youtube.com/watch?v=esmzYhuFnds)
- Métodos
    ...
    - [Clustering | Choosing The Number Of Clusters](https://www.youtube.com/watch?v=lbR5br5yvrY)
    - [K-means: Elbow Method and Silhouette](https://medium.com/@jonathanrmzg/k-means-elbow-method-and-silhouette-e565d7ab87aa)
...
- K-Means
    ...
    - [K Means Clustering Algorithm](https://www.youtube.com/watch?v=1XqG0kaJVHY)
    - [K-Mean Clustering](https://www.youtube.com/watch?v=wt-X61BnUCA)
    - [K Means Clustering Algorithm - Simplilearn](https://www.youtube.com/watch?v=Xvwt7y2jf5E)
    - [StatQuest: K-means clustering](https://www.youtube.com/watch?v=4b5d3muPQmA)
- Clustering Jerárquico
    - [StatQuest: Hierarchical Clustering](https://www.youtube.com/watch?v=7xHsRkOdVwo)
    - [Hierarchical Clustering - Fun and Easy Machine Learning](https://www.youtube.com/watch?v=EUQY3hL38cw)
    - [Hierarchical Clustering | Simplilearn](https://www.youtube.com/watch?v=9U4h6pZw6f8)
    - [Hierarchical Clustering - Dendrograms Using Scipy and Scikit-learn in Python](https://www.youtube.com/watch?v=JcfIeaGzF8A)

### Máquinas de soporte vectorial (SVM)

- [Support Vector Machines, Clearly Explained!!!](https://www.youtube.com/watch?v=efR1C6CvhmE)
- [Support Vector Machine: Complete Theory](https://towardsdatascience.com/understanding-support-vector-machine-part-1-lagrange-multipliers-5c24a52ffc5e)
...
- [Support Vector Machine - How Support Vector Machine Works](https://www.youtube.com/watch?v=TtKF996oEl8)
- [Lecture: Support Vector Machines - MIT](https://www.youtube.com/watch?v=_PwhiWxHK8o&t=1s)
...
- [Recommendation Systems by Google](https://developers.google.com/machine-learning/recommendation)
- [Understanding Content Based Recommender Systems](https://medium.com/analytics-vidhya/understanding-recommender-systems-introduction-3be54e937625)
...
- [Recommender System for Beginners](https://www.youtube.com/watch?v=U-yq3I9QugQ)
- [Introduction to Recommender Systems](https://tryolabs.com/blog/introduction-to-recommender-systems/)
- [Recommendation Systems using Machine Learning](https://www.youtube.com/watch?v=EjOlN6uVBOg)
...
- [Recommendation systems: Principles, methods and evaluation - So technical](https://www.sciencedirect.com/science/article/pii/S1110866515000341)
- [Building a Movie Recommendation Engine | Machine Learning Projects](https://www.youtube.com/watch?v=XoTwndOgXBM)
- [Recommender Systems | Problem Formulation — [ Machine Learning | Andrew Ng ]](https://www.youtube.com/watch?v=giIXNoiqO_U)
...
- Data para su libre uso
    - [UCI Datasets](https://archive.ics.uci.edu/ml/index.php)
    - [Kaggle](https://www.kaggle.com/)
    - [Datos abiertos del gobierno de EUA.](http://data.gov)
    - [Datos abiertos de la Unión Europea](http://open-data.europa.eu/en/data/)
    - [Listado de 33 recursos de datos abiertos](https://www.forbes.com/sites/bernardmarr/2016/02/12/big-data-35-brilliant-and-free-data-sources-for-2016/#52df8c92b54d)
- Sitios interesantes
    - [Analytics Vidhya](https://datahack.analyticsvidhya.com/contest/all/)
    - [Data Driven](https://www.drivendata.org/)
    - C[rowd AI](https://www.crowdai.org/)
